...
//
// CMS-ready data shape: every field is a plain primitive. Drop in a new
// Cloudinary thumbnail + video URL and the entire case-study page rebuilds.
//
// Fields:
//   id            — url slug (used by /work/[slug])
//   title         — huge display title
//   category      — e.g. 'Brand Film', 'Title Sequence'
//   year          — e.g. '2025'
//   description   — long-form paragraph for the case study
//   thumbnail     — grid card image (Cloudinary, Unsplash, anything)
//   videoUrl      — MP4 / WebM / HLS — autoplay-muted-loop on the case page
//   softwareUsed  — array of tool names rendered as chips
//   credits       — free-form attribution string
//   links         — only non-empty keys are shown; supported keys:
//                   instagram, behance, youtube, vimeo, website, github,
//                   drive, custom
